...
public abstract class DistanceFetcherWithTraffic {

    public double[] timeSlots;
    public double[] scalingFactors;
    public MultiTypeMatrixWithTraffic multiTypeMatrix;
    Integer numberOfPoints;

    DistanceFetcherWithTraffic() {};
    ...
    public MultiTypeMatrixWithTraffic fetchDistance(){
