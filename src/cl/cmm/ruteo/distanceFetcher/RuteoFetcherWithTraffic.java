...
public class RuteoFetcherWithTraffic extends DistanceFetcherWithTraffic {

    public RuteoFetcherWithTraffic(ArrayList<Pair<Double,Double>> points , Set<String> profiles, String folderName, String fileName,double[] timeSlots, double[] scalingFactors) throws Exception {
        StringBuilder stringBuilder = new StringBuilder();
        this.timeSlots = timeSlots;
        this.scalingFactors = scalingFactors;
        this.multiTypeMatrix = new MultiTypeMatrixWithTraffic(timeSlots, scalingFactors);
